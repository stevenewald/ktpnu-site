          ...
          <div className="">
            ...
            <div className="flex items-center pb-2">
              ...
              <div className="text-2xl font-semibold tracking-tight text-gray-900 sm:text-3xl">
                KTP Pledge Calendar (Will be updated by week 4)
              </div>
            </div>

            {/* Subtitle */}
            {false && <div className="mx-auto text-sm inline-block text-gray-500 flex items-center">
            ...
            <div className="mx-auto text-sm inline-block text-gray-500 flex items-center">
              These are rough estimates and will be updated after we determine the pledge class' availability. Not all events have been added (including SWE/technical workshop, capstone events, speaker series, etc).
            </div>
          </div>
