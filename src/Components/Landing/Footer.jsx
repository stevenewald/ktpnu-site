            ...
            <footer className="bg-indigo-600">
              <div className="mx-auto max-w-7xl py-6 px-4 sm:px-6 md:flex md:items-center md:justify-between lg:px-8">
                <div className="flex justify-center space-x-6 md:order-2">
                  ...
                  {navigation.map((item) => (
                    <a key={item.name} href={item.href} className="text-gray-50 transition hover:text-gray-300">
                ...
                <div className="mt-8 md:order-1 md:mt-0">
                  <p className="text-center text-base text-gray-50">&copy; 2022 Kappa Theta Pi Kappa Chapter. All Rights Reserved.</p>
                </div>
              </div>
            </footer>
          )
