...
function CarouselCard(props) {
  ...
  return (
    <>
      ...
      {/* Light Themed */}
      <div className='h-full container inline-block w-96 h-[90%] rounded-2xl shadow-lg hover:shadow-xl transition-shadow overflow-hidden border hover:scale-105 transition' style={dimmedBG}>
        ...
        <div className="p-6">
          ...
          <div className="">
            ...
            {/* Event Title */}
            <p className="mt-2 text-2xl font-bold tracking-tight sm:text-3xl" style={dimmedTitle}>{props.title}</p>

            {/* Time & Location */}
            <p className="mt-1 text-md font-bold tracking-tight text-gray-400 sm:text-md">{props.time} @ {props.location}</p>
          </div>
