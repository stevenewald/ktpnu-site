const faqs: { question: string; answer: string }[] = [
  ...
  },
  {
    ...
    answer:
      "Kappa Theta Pi's members come from many tech related majors, including Computer Science, Economics, MatSci, Industrial Engienering, Biomedical Engineering, Computer Engineering, and more. We welcome all who are passionate about tech, regardless of major or past experience - We are open to all.",
  },
];
