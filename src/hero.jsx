...
class Hero extends React.Component {
    ...
    render() {
        return (
            <section className="w-full min-h-screen bg-white bg-cover bg-full bg-no-repeat" style={{backgroundImage:"url(https://ktpmichigan.com/assets/img/home/landing.png)",backgroundPosition:"0 25px"}} id='Home'>
                <div className="container relative flex flex-col min-h-screen px-6 py-8 mx-auto">
                    ...
                    <section className="flex items-center flex-1 mb-80 lg:mb-64">
                        <div className="flex flex-col w-full ">
                            ...
                            <div className="flex justify-center opacity-0 transition-opacity transition-all duration-1000 -translate-y-6 ease-in-out" ref={this.downArrow}>
                                <svg className="rotate-90 mt-12 scale-125 transform" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M0 3.795l2.995-2.98 11.132 11.185-11.132 11.186-2.995-2.981 8.167-8.205-8.167-8.205zm18.04 8.205l-8.167 8.205 2.995 2.98 11.132-11.185-11.132-11.186-2.995 2.98 8.167 8.206z"/></svg>
                            </div>
                        </div>
                    </section>
                </div>
