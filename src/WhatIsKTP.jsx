...
export default function Example() {
  return (
    <div className="relative overflow-hidden bg-white pt-16 pb-32">
      ...
      <div className="mx-auto max-w-7xl pb-10 pt-4 px-4 sm:pb-20 sm:pt-6 sm:px-6 lg:px-8">
          <div className="text-center">
            <p className="mt-1 text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl lg:text-6xl">
              What is Kappa Theta Pi?
            </p>
          </div>
        </div>
        <div className="lg:mx-auto lg:grid lg:max-w-7xl lg:grid-flow-col-dense lg:grid-cols-2 lg:gap-24 lg:px-8">
          <div className="mx-auto max-w-xl px-6 lg:mx-0 lg:max-w-none lg:py-16 lg:px-0">
            <div>
              ...
              <div className="mt-6">
                <h2 className="text-3xl font-bold tracking-tight text-gray-900">A tech-centered community</h2>
          ...
          <div className="mt-12 sm:mt-16 lg:mt-0">
            <div className="-mr-48 pl-4 sm:pl-6 md:-mr-16 lg:relative lg:m-0 lg:h-full lg:px-0">
              <img
                ...
                src="https://images.squarespace-cdn.com/content/v1/56106686e4b0b27692195f5d/1648587136299-ZW6YK930TT7VFV7DPRGM/groups-76+%281%29.jpg"
